...
export default {
  ...
  created() {
    ...
    this.$on('register-component', this['register-component']);
    this.$on('g-bounds_changed', this['g-bounds_changed']);
    this.$on('g-fitBounds', this['g-fitBounds']);
    this.$on('g-resize-map', this['g-resize-map']);
  },
