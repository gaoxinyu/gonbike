...
var Rxports = {
    ...
    */
    ...
    ajax:function (opt){
        ...
        axios({
            ...
            url: opts.url,
            params: (opts.type == 'get' || opts.type == 'delete') ? opts.data : {},
            data: (opts.type != 'get' && opts.type != 'delete') ? opts.data : {},
    ...
    */
    ...
    setRem: {
        ...
        on() {
            window.onresize = () => {
                window.setTimeout(() => this.resetRem(), 300);
            }
        }
    },
    isIos: function(){
    ...
    getIosVersion: function(){
        const regResult = /(iPhone|iPad|iPod) OS ([\d_]+)/.exec(navigator.userAgent);
